...
class PublicTransport:
    ...
    def __init__(self, brand, year, color, engine_power, max_speed):
        self.brand = brand
        self.year = year
        self.color = color
...
class Bus(PublicTransport):
    def __init__(self, brand, year, color, engine_power, max_speed, passengers, park, fare):
        super().__init__(brand, year, color, engine_power, max_speed)
...
class Tram(PublicTransport):
    def __init__(self, brand, year, color, engine_power, max_speed, route, path, fare):
        super().__init__(brand, year, color, engine_power, max_speed)
        self.__route = route
        self.path = path
        self._fare = fare
