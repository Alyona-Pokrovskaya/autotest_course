...
def create_phone_number(num_tuple):
    str_phone_1 = ''.join(map(str, num_tuple[0:3]))
    str_phone_2 = ''.join(map(str, num_tuple[3:6]))
    str_phone_3 = ''.join(map(str, num_tuple[6:]))
    str_phone = '(' + str_phone_1 + ')' + ' ' + str_phone_2 + '-' + str_phone_3
